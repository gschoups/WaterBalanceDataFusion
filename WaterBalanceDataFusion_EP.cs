...
namespace WaterBalanceDataFusion
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 22:12 on Friday, 17 November 2023.
	/// </remarks>
	public partial class WaterBalanceDataFusion_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_EObs1_EObs2_Nt_numberOfIterations_Par_ParPrior_PObs1_PObs2_PStd_QObs_QObsVar_S0Prior_SObs(int numberOfIterations)
		{
			...
			Gaussian[] vdouble78_B = new Gaussian[this.Nt];
			for(int index0 = 0; index0<this.Nt; index0++) {
				if (index0==0) {
					vdouble78_B[index0] = Gaussian.Uniform();
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int index0 = this.Nt-1; index0>=0; index0--) {
					...
					if (index0==0) {
						// Message to 'vdouble78' from Difference factor
						vdouble78_B[index0] = DoublePlusOp.SumAverageConditional(this.S_use_B[0], this.Q_uses_F[0][1]);
						// Message to 'vdouble77' from Difference factor
						vdouble77_B[index0] = DoublePlusOp.SumAverageConditional(vdouble78_B[index0], this.E_uses_F[0][1]);
					...
					if (index0==0) {
						...
						E_0_0__B[index0] = DoublePlusOp.BAverageConditional(this.vdouble77_F[index0], vdouble78_B[index0]);
